...
const Dsp300 = () => {
  return (
    <div>
      <Navbar/>
      <Enroll title='Digital Training program 300 (DSP-300)' subtitle='Building this next generation of techies' src='shine-young-people-discussing-work-issues-1 1.png'/>
